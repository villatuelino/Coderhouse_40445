...
urlpatterns = [
    ...
    #     path("producto_categoria_delete/<int:pk>", views.producto_categoria_delete, name="producto_categoria_delete"),
    #     path("producto_categoria_update/<int:pk>", views.producto_categoria_delete, name="producto_categoria_delete"),
